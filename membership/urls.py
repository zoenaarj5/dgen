...
urlpatterns = [
    ...
    path("edit-member-success/<int:member_id>",views.editMemberSuccess,name="editMemberSuccess"),
    ...
    path("add-country/",views.addCountry,name="addCountry"),
    path("add-country-success/<str:country_code>",views.addCountrySuccess,name="addCountrySuccess"),
    ...
    path("edit-federation/<int:federation_id>",views.editFederation,name="editFederation"),
    path("edit-federation-success/<int:federation_id>",views.editFederationSuccess,name="editFederationSuccess"),
